...
.project-header {
  ...
  color: #000; /* project name black */
}

.project-header a.project-link {
  text-decoration: none;
  color: #000; /* project name link black */
}
...
/* Project links: PDF blue, slides/poster orange */
.project-links a.pdf {
  color: #1f6feb; /* blue */
  font-weight: 500;
  text-decoration: none;
...
<div class="project-item">
  <div class="project-header">
    ...
    <span class="project-links">
      [<a class="pdf" href="https://docs.google.com/viewer?url=https://raw.githubusercontent.com/Joysaha189/CSI-Based-Sign-Language-Recognition-Using-CNN-GRU-Architecture-Enhanced-with-Attention/main/Deliverables/DL_Project%20Report.pdf" target="_blank" rel="noopener">Report</a>]
      [<a class="slides" href="https://docs.google.com/viewer?url=https://raw.githubusercontent.com/Joysaha189/CSI-Based-Sign-Language-Recognition-Using-CNN-GRU-Architecture-Enhanced-with-Attention/main/Deliverables/Project%20Presentation.pdf" target="_blank" rel="noopener">Slides</a>]
    </span>
  </div>
  ...
  <p class="project-keywords"><strong>Keywords:</strong> CSI, Deep Learning, Human Activity Recognition</p>
</div>
...
<div class="project-item">
  ...
  <div class="project-separator"></div>
  <p class="project-desc">
    Built a digital logic-controlled 3-floor elevator model using combinational and sequential logic circuits.
  </p>
...
<div class="project-item">
  ...
  <div class="project-separator"></div>
  <p class="project-desc">
    Developed a system to measure and display heart rate using sensors and microcontroller for real-time monitoring.
  </p>
...
<div class="project-item">
  ...
  <div class="project-separator"></div>
  <p class="project-desc">
    Implemented adaptive filtering techniques to track non-stationary signals in noisy environments.
  </p>
...
<div class="project-item">
  ...
  <div class="project-separator"></div>
  <p class="project-desc">
    Developed a smart home IoT system for remote appliance control, monitoring, and automation.
  </p>
  <p class="project-keywords"><strong>Keywords:</strong> IoT, Home Automation</p>
</div>
